...
// Responsive Main-Menu
	var page_wrapper = $('#page_wrapper'),
		...
		zn_back_text = 'Fechar e voltar',
		back_text = '<li class="zn_res_menu_go_back"><span class="zn_res_back_icon glyphicon glyphicon-chevron-left"></span><a>'+zn_back_text+'</a></li>',
...
// Load Date in the current div 
	$.ajax({
	  url: "assets/php_helpers/date.php",
